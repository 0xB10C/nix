...
rustPlatform.buildRustPackage rec {
  name = "peer-observer";
  pname = "peer-observer";
  version = "47ad2453046badfbf82539df168c7e6ec76755e4";

  src = pkgs.fetchFromGitHub {
    owner = "peer-observer";
    repo = "peer-observer";
    rev = version;
    sha256 = "sha256-OpP1hWY7o3zfI6gltlfc9Z4FkY5cHBfyjqDrm7ruDQw=";
  };
  ...
  cargoHash = "sha256-3FvedxQ3yhLEuYJZLaYbIm3uBVItRQBaH2Ei+tR8FOU=";
